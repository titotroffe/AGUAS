...
return new class extends Migration
{
    ...
    {
        $moduloId = 7; // Control de Tanques de Escuelas e Instituciones
        ...
        // Tipos de medición requeridos (todos bacteriológicos, idénticos al Modulo 6)
        $tiposMedicionIds = [
    ...
    {
        DB::table('lab_mediciones')->where('modulo_id', 7)->delete();
    }
};
