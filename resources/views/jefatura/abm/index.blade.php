...
<body class="bg-slate-800 text-slate-200 font-sans min-h-screen p-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="relative flex items-center justify-center mb-12">
            <a href="{{ route('jefatura.index') }}" class="absolute left-0 top-1/2 -translate-y-1/2 bg-slate-700 hover:bg-slate-600 text-white py-2 px-6 rounded border border-slate-500 transition text-sm font-semibold">
                 ← VOLVER A JEFATURA
            </a>
            <h1 class="text-2xl font-bold text-white tracking-wider text-center m-0">ABM - ADMINISTRADOR DE TABLAS</h1>
        </div>

        <div class="bg-slate-900/40 border border-slate-700 rounded-xl p-8 shadow-2xl">
